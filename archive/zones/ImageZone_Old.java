...
public class ImageZone_Old extends LightBoardZone {
    ...
    @Inject
    public ImageZone_Old(LightBoardSurface surface, Sync sync) {
        super(surface, sync);
    ...
    public ImageZone_Old loadImage(String filename) {
