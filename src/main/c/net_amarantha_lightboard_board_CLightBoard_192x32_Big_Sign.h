...
#include <jni.h>
/* Header for class net_amarantha_lightboard_board_CLightBoard_192x32_Big_Sign */

#ifndef _Included_net_amarantha_lightboard_board_CLightBoard_192x32_Big_Sign
#define _Included_net_amarantha_lightboard_board_CLightBoard_192x32_Big_Sign
#ifdef __cplusplus
extern "C" {
#endif
/*
 * Class:     net_amarantha_lightboard_board_CLightBoard_192x32_Big_Sign
 * Method:    initNative
 * Signature: (II)V
 */
